...
#### ✨ 新功能
- **选项页面功能**：新增独立的选项页面(`formatter.html/js/css`)，支持手动粘贴JSON进行格式化
- **缩进引导**：添加了JSON结构可视化的缩进引导线，提升代码可读性

#### 🐛 修复
- **缩进格式化**：修正了数组和对象结尾括号的缩进显示问题

#### 🔧 配置更新
- **构建脚本**：更新`build.sh`脚本，支持选项页面文件的复制和验证逻辑
- **项目文档**：更新AGENTS.md、BUILD_README.md、USER_GUIDE.md等项目文档
- **Manifest配置**：在`manifest.json`中添加`options_page`配置
